...
1. Expand ![Expansion selector](../assets/icon-display-expand.png) the **[!UICONTROL General]** section and do the following:
    ...
    - To expose the stock of this source to the storefront, set **[!UICONTROL Visible on Storefront]** to `Yes`.
...
|[!UICONTROL Visible on Storefront]|Determines if the storefront [`sourceAvailability`](https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/source-availability){target="_blank"} GraphQL query can return stock information for this inventory source.|
